...
**Font import:**
```html
<link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;1,9..40,400&display=swap" rel="stylesheet">
```
...
:root {
  ...
  --font-title: 'Manrope', -apple-system, Arial, sans-serif;
...
- Manrope 800 ExtraBold for all display text (clean, powerful, versatile).
- DM Sans for body.
...
### Creative Voltage
Electric blue + neon yellow, halftone textures. Manrope + Space Mono.
...
- Fonts: `Manrope` (800 display / 400–500 body), `Space Mono` (400/700 labels)
...
| Dark-Midnight | Manrope | DM Sans | Google |
| Light-Serenity | Plus Jakarta Sans | Plus Jakarta Sans | Google |
| Bold Signal | Archivo Black | Space Grotesk | Google |
| Electric Studio | Manrope | Manrope | Google |
| Creative Voltage | Manrope | Space Mono | Google |
